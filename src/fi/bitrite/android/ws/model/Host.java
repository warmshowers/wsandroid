...
public class Host extends _Host {
	...
	public String getServices() {
		...
		if (getShower().equals("1")) 		sb.append("Shower\n");
		if (getFood().equals("1")) 			sb.append("Food\n");
		if (getBed().equals("1")) 			sb.append("Bed\n"); 
		if (getLaundry().equals("1")) 		sb.append("Laundry\n");
		if (getStorage().equals("1")) 		sb.append("Storage\n");
		if (getKitchenUse().equals("1"))	sb.append("Use of kitchen\n");
		if (getLawnspace().equals("1"))		sb.append("Lawn space (for camping)\n");
		if (getSag().equals("1"))			sb.append("SAG (vehicle support)\n");
